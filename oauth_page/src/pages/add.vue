    ...
    <div id="add-forms">
      ...
      <a-form layout="horizontal">
        ...
        <a-form-item label="设备类型" :required="true" :labelCol="labelCol" :wrapperCol="wrapperCol" >
          <a-select  placeholder="请选择设备类型" @change="handleChangeType">
            <a-select-option v-for="item in deviceTypeData" :key="item.value">{{item.title}}</a-select-option>
          </a-select>
        </a-form-item>
        <a-form-item label="设备位置" :required="true" :labelCol="labelCol" :wrapperCol="wrapperCol" >
          <a-select :defaultValue="'门口'"  placeholder="请选择设备位置" @change="handleChangeZone">
        ...
        <a-form-item  label="操作类型" :required="true" :labelCol="labelCol" :wrapperCol="wrapperCol" >
